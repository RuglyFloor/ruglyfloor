        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            <Link to={createPageUrl('Shop')}>
              <button className="bg-transparent border border-white text-white font-black text-4xl px-12 py-6 hover:bg-white/10 transition-all tracking-wide" style={{ fontFamily: 'Qwitcher Grypen, cursive', textShadow: '2px 2px 0 rgba(0,0,0,0.5), -1px -1px 0 rgba(0,0,0,0.5), 1px -1px 0 rgba(0,0,0,0.5), -1px 1px 0 rgba(0,0,0,0.5)' }}>
