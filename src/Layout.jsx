...
export default function Layout({ children, currentPageName }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Barlow+Condensed:wght@700;900&family=Roboto:wght@400;500;700&family=Big+Shoulders+Stencil+Display:wght@700;900&display=swap&font-display=swap');
